...
> NOTE: you can find the video version of this tutorial in Alchemy's official Youtube channel: [Connect APIs to your Smart Contracts using Chainlink | Road to Web3](https://www.youtube.com/watch?v=hNdXSMKLDi4)
